...
const CreateProject = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_API_URL}/create-project`, formattedData);
      alert(response.data); // Display response message
      setProjectData({ title: '', description: '', goalAmount: '', endDate: '' }); // Reset form
    } catch (error) {
